...
namespace arkana::sha2
{
    namespace avx2
    {
        namespace impl
        {
            ...
            using functions::round_sha1;
            using functions::round_sha2;
            ...
            static void process_chunk_sha1(vector_t<uint32_t>& vec, const chunk_t<uint32_t>& input) noexcept
            {
                ...
                vu32x4 x4 = rotate_sha1_x4(x0, x1, x2, x3);
                {
                    ...
                    round_sha1<00 + 0>(x, ck0[0]);
                    round_sha1<00 + 1>(x, ck0[1]);
                    round_sha1<00 + 2>(x, ck0[2]);
                    round_sha1<00 + 3>(x, ck0[3]);
                    round_sha1<00 + 4>(x, ck1[0]);
                    round_sha1<00 + 0>(x, ck1[1]);
                    round_sha1<00 + 1>(x, ck1[2]);
                    round_sha1<00 + 2>(x, ck1[3]);
                    round_sha1<00 + 3>(x, ck2[0]);
                    round_sha1<00 + 4>(x, ck2[1]);
                    round_sha1<00 + 0>(x, ck2[2]);
                    round_sha1<00 + 1>(x, ck2[3]);
                    round_sha1<00 + 2>(x, ck3[0]);
                    round_sha1<00 + 3>(x, ck3[1]);
                    round_sha1<00 + 4>(x, ck3[2]);
                    round_sha1<00 + 0>(x, ck3[3]);
                    round_sha1<00 + 1>(x, ck4[0]);
                    round_sha1<00 + 2>(x, ck4[1]);
                    round_sha1<00 + 3>(x, ck4[2]);
                    round_sha1<00 + 4>(x, ck4[3]);
                }
                ...
                {
                    auto k1 = u32x4(functions::round_constants_sha1::k[1]);
                    auto ck5 = to_array(x5 + k1);
                    auto ck6 = to_array(x6 + k1);
                    auto ck7 = to_array(x7 + k1);
                    auto ck8 = to_array(x8 + k1);
                    auto ck9 = to_array(x9 + k1);
                    round_sha1<20 + 0>(x, ck5[0]);
                    round_sha1<20 + 1>(x, ck5[1]);
                    round_sha1<20 + 2>(x, ck5[2]);
                    round_sha1<20 + 3>(x, ck5[3]);
                    round_sha1<20 + 4>(x, ck6[0]);
                    round_sha1<20 + 0>(x, ck6[1]);
                    round_sha1<20 + 1>(x, ck6[2]);
                    round_sha1<20 + 2>(x, ck6[3]);
                    round_sha1<20 + 3>(x, ck7[0]);
                    round_sha1<20 + 4>(x, ck7[1]);
                    round_sha1<20 + 0>(x, ck7[2]);
                    round_sha1<20 + 1>(x, ck7[3]);
                    round_sha1<20 + 2>(x, ck8[0]);
                    round_sha1<20 + 3>(x, ck8[1]);
                    round_sha1<20 + 4>(x, ck8[2]);
                    round_sha1<20 + 0>(x, ck8[3]);
                    round_sha1<20 + 1>(x, ck9[0]);
                    round_sha1<20 + 2>(x, ck9[1]);
                    round_sha1<20 + 3>(x, ck9[2]);
                    round_sha1<20 + 4>(x, ck9[3]);
                }
                ...
                {
                    auto k2 = u32x4(functions::round_constants_sha1::k[2]);
                    ...
                    round_sha1<40 + 0>(x, ck10[0]);
                    round_sha1<40 + 1>(x, ck10[1]);
                    round_sha1<40 + 2>(x, ck10[2]);
                    round_sha1<40 + 3>(x, ck10[3]);
                    round_sha1<40 + 4>(x, ck11[0]);
                    round_sha1<40 + 0>(x, ck11[1]);
                    round_sha1<40 + 1>(x, ck11[2]);
                    round_sha1<40 + 2>(x, ck11[3]);
                    round_sha1<40 + 3>(x, ck12[0]);
                    round_sha1<40 + 4>(x, ck12[1]);
                    round_sha1<40 + 0>(x, ck12[2]);
                    round_sha1<40 + 1>(x, ck12[3]);
                    round_sha1<40 + 2>(x, ck13[0]);
                    round_sha1<40 + 3>(x, ck13[1]);
                    round_sha1<40 + 4>(x, ck13[2]);
                    round_sha1<40 + 0>(x, ck13[3]);
                    round_sha1<40 + 1>(x, ck14[0]);
                    round_sha1<40 + 2>(x, ck14[1]);
                    round_sha1<40 + 3>(x, ck14[2]);
                    round_sha1<40 + 4>(x, ck14[3]);
                }
                ...
                {
                    auto k3 = u32x4(functions::round_constants_sha1::k[3]);
                    ...
                    round_sha1<60 + 0>(x, ck15[0]);
                    round_sha1<60 + 1>(x, ck15[1]);
                    round_sha1<60 + 2>(x, ck15[2]);
                    round_sha1<60 + 3>(x, ck15[3]);
                    round_sha1<60 + 4>(x, ck16[0]);
                    round_sha1<60 + 0>(x, ck16[1]);
                    round_sha1<60 + 1>(x, ck16[2]);
                    round_sha1<60 + 2>(x, ck16[3]);
                    round_sha1<60 + 3>(x, ck17[0]);
                    round_sha1<60 + 4>(x, ck17[1]);
                    round_sha1<60 + 0>(x, ck17[2]);
                    round_sha1<60 + 1>(x, ck17[3]);
                    round_sha1<60 + 2>(x, ck18[0]);
                    round_sha1<60 + 3>(x, ck18[1]);
                    round_sha1<60 + 4>(x, ck18[2]);
                    round_sha1<60 + 0>(x, ck18[3]);
                    round_sha1<60 + 1>(x, ck19[0]);
                    round_sha1<60 + 2>(x, ck19[1]);
                    round_sha1<60 + 3>(x, ck19[2]);
                    round_sha1<60 + 4>(x, ck19[3]);
                }
            ...
            static void process_chunk_sha2(vector_t<T>& vec, const chunk_t<T>& input) noexcept
            {
                ...
                for (size_t i = 0; i < (round_constants::rounds / 16); i++)
                {
                    ...
                    round_sha2<S00, S01, S02, S10, S11, S12, 3>(vec, ck[3]);
                    round_sha2<S00, S01, S02, S10, S11, S12, 4>(vec, ck[4]);
                    round_sha2<S00, S01, S02, S10, S11, S12, 5>(vec, ck[5]);
                    round_sha2<S00, S01, S02, S10, S11, S12, 6>(vec, ck[6]);
                    round_sha2<S00, S01, S02, S10, S11, S12, 7>(vec, ck[7]);
                    round_sha2<S00, S01, S02, S10, S11, S12, 0>(vec, ck[8]);
                    round_sha2<S00, S01, S02, S10, S11, S12, 1>(vec, ck[9]);
                    round_sha2<S00, S01, S02, S10, S11, S12, 2>(vec, ck[10]);
                    round_sha2<S00, S01, S02, S10, S11, S12, 3>(vec, ck[11]);
                    round_sha2<S00, S01, S02, S10, S11, S12, 4>(vec, ck[12]);
                    round_sha2<S00, S01, S02, S10, S11, S12, 5>(vec, ck[13]);
                    round_sha2<S00, S01, S02, S10, S11, S12, 6>(vec, ck[14]);
                    round_sha2<S00, S01, S02, S10, S11, S12, 7>(vec, ck[15]);
        ...
        static inline void finalize_and_get_digest(md5_state_t& stt, md5_digest_t* out) noexcept { return ref::finalize_and_get_digest(stt, out); } // TODO: optimize for avx2(?)
        static inline void finalize_and_get_digest(sha1_state_t& stt, sha1_digest_t* out) noexcept { return functions::finalize_and_get_digest<sha1_state_t, impl::process_chunk_sha1>(stt, out); }
        static inline void finalize_and_get_digest(sha224_state_t& stt, sha224_digest_t* out) noexcept { return functions::finalize_and_get_digest<sha224_state_t, impl::process_chunk_sha256>(stt, out); }
        static inline void finalize_and_get_digest(sha256_state_t& stt, sha256_digest_t* out) noexcept { return functions::finalize_and_get_digest<sha256_state_t, impl::process_chunk_sha256>(stt, out); }
        static inline void finalize_and_get_digest(sha384_state_t& stt, sha384_digest_t* out) noexcept { return functions::finalize_and_get_digest<sha384_state_t, impl::process_chunk_sha512>(stt, out); }
        static inline void finalize_and_get_digest(sha512_state_t& stt, sha512_digest_t* out) noexcept { return functions::finalize_and_get_digest<sha512_state_t, impl::process_chunk_sha512>(stt, out); }
        static inline void finalize_and_get_digest(sha512_224_state_t& stt, sha512_224_digest_t* out) noexcept { return functions::finalize_and_get_digest<sha512_224_state_t, impl::process_chunk_sha512>(stt, out); }
        static inline void finalize_and_get_digest(sha512_256_state_t& stt, sha512_256_digest_t* out) noexcept { return functions::finalize_and_get_digest<sha512_256_state_t, impl::process_chunk_sha512>(stt, out); }
    }
}
